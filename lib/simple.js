...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Simpel chanel', body: wm, sourceUrl: 'https://youtube.com/channel/UCjy5_8OQV91Zdag3hoUW5LQ', thumbnail: data }}, options })
    }
